...
export class AdminService extends BaseService {
    ...
    async getProfile(email) {
        ...
        try {
            ...
            if (!profile) {
                ...
                throw new DomainError("Staff profile not found", ERROR_CODES.RESOURCE_NOT_FOUND, 404);
            }
            const result = {
                id: profile.id,
            ...
            this.logger.debug({ result, layer: "Service" }, "[AdminService] getProfile returning");
            return result;
        }
        catch (err) {
            if (err instanceof DomainError)
                throw err;
            throw new RepositoryError("Failed to fetch admin profile", ERROR_CODES.DB_FAILURE);
        }
    }
    // =====================================================================================
    /**
    ...
    async createStaff(data) {
        ...
        try {
            ...
            try {
                ...
                this.logger.warn({ err }, "Failed to generate invite link, but staff created");
            }
            // 4. Save to database
            ...
            if (err instanceof DomainError)
                throw err;
            throw new RepositoryError("Failed to create staff member", ERROR_CODES.DB_FAILURE);
        }
    }
    /**
    ...
    async getPaginatedStaff(filters) {
        ...
        try {
            ...
            throw new RepositoryError("Failed to fetch staff list", ERROR_CODES.DB_FAILURE);
        }
    }
    /**
    ...
    async updateStaff(id, data) {
        ...
        try {
            ...
            if (err instanceof DomainError)
                throw err;
            throw new RepositoryError("Failed to update staff profile", ERROR_CODES.DB_FAILURE);
        }
    }
    /**
    ...
    async deleteStaff(id) {
        ...
        try {
            ...
            try {
                ...
                this.logger.error({ error, wso2_id: profile.user.wso2_id }, "Failed to delete user from WSO2, proceeding with local delete");
            }
            ...
            if (err instanceof DomainError)
                throw err;
            throw new RepositoryError("Failed to delete staff member", ERROR_CODES.DB_FAILURE);
        }
    }
}
