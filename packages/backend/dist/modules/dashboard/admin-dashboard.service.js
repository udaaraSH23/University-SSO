...
import { ERROR_CODES, RepositoryError } from "../../errors";
...
export class AdminDashboardService extends BaseService {
    ...
    async getStats() {
        ...
        try {
            const [totalStudents, totalCourses, totalDepartments, totalFaculties] = await Promise.all([
            ...
            throw new RepositoryError("Failed to fetch admin dashboard stats", ERROR_CODES.DB_FAILURE);
        }
    }
}
