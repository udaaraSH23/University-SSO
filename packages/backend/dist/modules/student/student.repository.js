...
export class StudentRepository {
    ...
    async findProfileByEmail(email) {
        ...
        try {
            ...
            const result = Object.assign(Object.assign({}, user.studentProfile), { email: user.email, degreeProgram: user.studentProfile.degreeProgram });
            logger.debug({ result, layer: "Repository" }, "[StudentRepository] findProfileByEmail returning");
            return result;
        }
        catch (error) {
            logger.error({ error, email }, "Failed to find profile by email");
            throw new RepositoryError("Failed to find profile by email", ERROR_CODES.DB_FAILURE);
        }
    }
    /**
     ...
     * @throws RepositoryError on database failure
     */
    async findEnrollments(studentProfileId, filters) {
        ...
        try {
            ...
            logger.debug({ count: result.length, result, layer: "Repository" }, "[StudentRepository] findEnrollments returning");
            return result;
        }
        catch (error) {
            logger.error({ error, studentProfileId, filters }, "Failed to find enrollments");
            throw new RepositoryError("Failed to find enrollments", ERROR_CODES.DB_FAILURE);
        }
    }
    /**
     ...
     * @throws RepositoryError on database failure
     */
    async findBorrowRecords(studentProfileId, status) {
        ...
        try {
            ...
            logger.debug({ count: result.length, result, layer: "Repository" }, "[StudentRepository] findBorrowRecords returning");
            return result;
        }
        catch (error) {
            logger.error({ error, studentProfileId, status }, "Failed to find borrow records");
            throw new RepositoryError("Failed to find borrow records", ERROR_CODES.DB_FAILURE);
        }
    }
    /**
    ...
    async findPaginatedStudents(filters) {
        const { page, limit, query, level, facultyId, departmentId, degreeProgramId, academicYear, } = filters;
        ...
        if (facultyId || departmentId) {
            where.degreeProgram = Object.assign(Object.assign({}, (where.degreeProgram || {})), { department: Object.assign(Object.assign({}, (departmentId && { id: departmentId })), (facultyId && { facultyId: facultyId })) });
        }
        try {
            ...
            throw new RepositoryError("Failed to find paginated students", ERROR_CODES.DB_FAILURE);
        }
    }
    /**
    ...
    async findFullProfileById(id) {
        ...
        try {
            ...
            return Object.assign(Object.assign({}, student), { email: student.user.email, degreeProgram: student.degreeProgram.name });
        }
        catch (error) {
            logger.error({ error, id }, "Failed to find full profile by ID");
            throw new RepositoryError("Failed to find full profile by ID", ERROR_CODES.DB_FAILURE);
        }
    }
    /**
    ...
    async findById(id) {
        try {
            ...
            throw new RepositoryError("Failed to find student by ID", ERROR_CODES.DB_FAILURE);
        }
    }
    /**
     ...
     */
    async create(data) {
        logger.debug({ username: data.user.username }, "Creating student in database");
        try {
            ...
            throw new RepositoryError("Failed to create student in database", ERROR_CODES.DB_FAILURE);
        }
    }
    /**
    ...
    async update(id, data) {
        ...
        try {
            return await prisma.studentProfile.update({
                where: { id },
                data: Object.assign({ full_name: data.full_name, currentAcademicYear: data.currentAcademicYear, level: data.level }, (data.degreeProgramId && {
                    degreeProgram: {
            ...
            throw new RepositoryError("Failed to update student in database", ERROR_CODES.DB_FAILURE);
        }
    }
    /**
    ...
    async delete(id) {
        ...
        try {
            ...
            throw new RepositoryError("Failed to delete student from database", ERROR_CODES.DB_FAILURE);
        }
    }
}
